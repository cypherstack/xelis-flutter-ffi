    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok = Ok::<_, ()>(api_that_guard.level.clone())?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
...
let decode_indices_ = flutter_rust_bridge::for_generated::lockable_compute_decode_order(vec![flutter_rust_bridge::for_generated::LockableOrderInfo::new(&api_that, 0, false)]);
        ...
        let api_that_guard = api_that_guard.unwrap();
 let output_ok = crate::api::wallet::XelisWallet::create_multisig_transfer_all_transaction(&*api_that_guard, api_str_address, api_asset_hash, api_extra_data, api_encrypt_extra_data).await?;   std::result::Result::Ok(output_ok)
                    })().await)
                } })
}
...
let decode_indices_ = flutter_rust_bridge::for_generated::lockable_compute_decode_order(vec![flutter_rust_bridge::for_generated::LockableOrderInfo::new(&api_that, 0, false)]);
        ...
        let api_that_guard = api_that_guard.unwrap();
 let output_ok = crate::api::wallet::XelisWallet::start_xswd(&*api_that_guard, api_cancel_request_dart_callback, api_request_application_dart_callback, api_request_permission_dart_callback, api_request_prefetch_permissions_dart_callback, api_app_disconnect_dart_callback).await?;   std::result::Result::Ok(output_ok)
                    })().await)
                } })
}
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok =
                        Ok::<_, ()>(crate::api::utils::format_coin(api_value, api_decimals))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__utils__format_xelis_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::utils::format_xelis(api_value))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__wallet__get_cached_table_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            transform_result_dco::<_, _, ()>((move || {
                let output_ok = Ok::<_, ()>(crate::api::wallet::get_cached_table())?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__utils__get_language_index_from_str_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                let output_ok =
                    Ok::<_, ()>(crate::api::utils::get_language_index_from_str(&api_input))?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__utils__get_mnemonic_words_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                let output_ok =
                    Ok::<_, ()>(crate::api::utils::get_mnemonic_words(api_language_index))?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
