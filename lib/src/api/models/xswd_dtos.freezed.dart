...
mixin _$AppInfo {
 ...
 String get id; String get name; String get description; String? get url; Map<String, PermissionPolicy> get permissions;
...
@useResult
$Res call({
 String id, String name, String description, String? url, Map<String, PermissionPolicy> permissions
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String description,  String? url,  Map<String, PermissionPolicy> permissions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppInfo() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.url,_that.permissions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String description,  String? url,  Map<String, PermissionPolicy> permissions)  $default,) {final _that = this;
switch (_that) {
case _AppInfo():
return $default(_that.id,_that.name,_that.description,_that.url,_that.permissions);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String description,  String? url,  Map<String, PermissionPolicy> permissions)?  $default,) {final _that = this;
switch (_that) {
case _AppInfo() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.url,_that.permissions);case _:
  return null;
...
/// Create a copy of AppInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = null,Object? url = freezed,Object? permissions = null,}) {
